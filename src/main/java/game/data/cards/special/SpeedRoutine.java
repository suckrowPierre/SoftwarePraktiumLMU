...
/**
 * This class implements the SpeedRoutine Card.
 *
 * @author Simon Hümmer
 */
public class SpeedRoutine extends Card {
    ...
    public SpeedRoutine() {
        cardName = CardName.SpeedRoutine;
        cardDescription = "Move your robot 3 spaces in the direction it is facing.";
    }
    ...
    public void activateCard(ServerConnectedPlayer player) {
        Logger.tag(LoggingTags.game.toString()).info("Activating Card 'SpeedRoutine' for player: " + player.getName());
